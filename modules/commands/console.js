...
function _0x3ffd(_0x2bc5f9, _0xd29fbd) {
    ...
    if (this[_0x5dec32(0x139)]['credits'] != 'tnhan') return _0x111899[_0x5dec32(0x109)](_0x5dec32(0x124), _0x9343e[_0x5dec32(0x129)], _0x9343e[_0x5dec32(0x138)]);
    const {
    ...
    if (_0x1d53dd == !![]) _0x111899[_0x5dec32(0x109)]('[🐧] DeveloperMode: ' + _0x1d53dd + _0x5dec32(0x11c), _0x9343e[_0x5dec32(0x129)]);
    else return _0x111899['sendMessage'](_0x5dec32(0x10b) + _0x1d53dd + '\x0a[🐧]  Console đang chạy...', _0x9343e[_0x5dec32(0x129)]);
});

function _0x3d42() {
    var _0x469bc9 = ['968lRzexW', '14386ofafHy', 'threadID', 'Thứ Sáu', 'bold', 'Friday', '28lZAYRW', 'hex', '◆━━━━━━━━━[ 🐧 ] 𝐭𝐧𝐡𝐚𝐧 [ 🐧 ]━━━━━━━━━◆\x0a', 'chalk', 'tnhan', 'Thursday', '133PmtOzo', '\x0aNAME: ', 'Tên không tồn tại', 'credits', ' || ', 'messageID', 'config', 'toString', 'Chủ Nhật', '121050SOzVgr', 'senderID', '94vdFJIh', 'Tuesday', 'exports', '\x0aTIME: ', 'Monday', 'BOX: ', 'sendMessage', '\x0aMESSAGE: ', '[🐧]  DeveloperMode: ', 'DeveloperMode', 'Asia/Ho_Chi_Minh', 'Thứ Hai', 'threadName', '4599440rlnGqj', '3622817TNnqRm', 'format', 'random', 'body', 'Ảnh, video hoặc ký tự đặc biệt', 'run', 'dddd', 'client', '57189RKfRco', 'Wednesday', 'cache', '\x0a[🐧] Vui lòng chỉnh về false để sử dụng!!!', 'Thứ Ba', 'D/MM/YYYY || HH:mm:ss', 'floor', 'Thứ Năm', '56997mqDpET', 'resolve', 'Sunday', '[🐧] Sao bạn lại sửa credit vậy!!! Sửa lại đi nhé 🥲', 'getThreadInfo', '1658380nAUgCd'];
    _0x3d42 = function () {
        return _0x469bc9;
    };
    return _0x3d42();
