...
[🐧] → Chỉ Admin Bot mới được sử dụng bot trong chat riêng.`, 'set', 'readFileSync', './../../config.json', 'client', 'PREFIX', '24KKyVfc', 'Currencies', `[🐧] → Bạn đang trong thời gian chờ!\
